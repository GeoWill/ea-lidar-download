...
def get_os_grid_tiles(aoi_gdf: gp.GeoDataFrame, grid_path: str) -> gp.GeoDataFrame:
    """
    ...
    intersecting_tiles = os_grid[os_grid.intersects(aoi_gdf.union_all())]
...
def main():
    ...
    parser.add_argument(
        'aoi',
        type=str,
        help='Path to AOI file (shapefile, GeoJSON, etc.)'
    )
    parser.add_argument(
        '--output-dir',
        '-o',
